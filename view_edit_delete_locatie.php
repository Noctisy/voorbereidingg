...
if (isset($_GET['id'])) {
  ...
  if(isset($_POST['export'])){
      ...
      $result = $db->get_locatie_information(NULL);
      if(!empty($result)){
...
<html>
  <head>
    <meta charset="utf-8">
    <title>View edit and delete locatie</title>
    ...
    <?php
        ...
        <div>
          <div>
            ...
            <a class="btn btn-success" href="locatie_toevoegen.php" style="margin-left:530;">locatie toevoegen</a>
                ...
                <table class="table table-striped table-hover">
                    ...
                    <?php foreach($results as $rows => $row){ ?>
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td>
                                <a class="btn btn-info" href="locatie_wijzigen.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="edit_btn" >Edit</a>
                            </td>
                            <td>
                              <a class="btn btn-danger" href="view_edit_delete_locatie.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="del_btn">Delete</a>
                            </td>
                      </tr>

                    <?php } ?>
              </table>
              <form action='view_edit_delete_locatie.php' method='POST'>
