  ...
  <body>
    <div>
      ...
      <?php
          ...
          $results = $db->get_amsterdam_information(NULL);
                  ...
                  <table class="table table-striped table-hover">
                      ...
                      <?php foreach($results as $rows => $row){ ?>
                          ...
                          <tr>
                              ...
                              <?php } ?>
                              <td>
                                  <a class="btn btn-info" href="voorraad3_wijzigen.php?id=<?php echo $row_id; ?>" class="edit_btn" >Edit</a>
                              </td>
                              <td>
                                  <a class="btn btn-danger" href="voorraad3.php?user_id=<?php echo $row_id; ?>&id=<?php echo $row['id']?>" class="del_btn">Delete</a>
                              </td>
                        </tr>
                      <?php } ?>
                </table>
